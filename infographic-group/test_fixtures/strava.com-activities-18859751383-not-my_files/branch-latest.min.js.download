...
function lb(a){var b={};b=H(b,"http_origin",document.URL);b=H(b,"user_agent",navigator.userAgent);b=H(b,"language",$a());b=H(b,"screen_width",screen.width||0);b=H(b,"screen_height",screen.height||0);b=H(b,"http_referrer",document.referrer);b=H(b,"browser_fingerprint_id",a.L);b=H(b,"developer_identity",a.m);b=H(b,"identity",a.m);b=H(b,"sdk","web");b=H(b,"sdk_version","2.87.1");b=mb(b,"model",y?y.model:"");return b=mb(b,"os_version",y?y.platformVersion:"")}
...
function Sc(){var a="",b="";document.body.style.transition="";document.getElementById("branch-banner-iframe")&&(document.getElementById("branch-banner-iframe").style.transition="");Dc||(a="body { -webkit-transition: all 0.375s ease; }\n",document.body.style.transition="all 00.375s ease",b="-webkit-transition: all 0.25s ease; transition: all 00.25s ease;");a=a||"";if(ic){var c=R,d=fc.va,e=Q;"overlay"===jc&&(d=c="100%!important",e="fixed");a=a+("#branch-banner-iframe-embed { z-index: 99999!important; height: "+
...
d.D)),null);if(0===d.A||!d.A)return g(Error(A("Branch SDK not initialized")),null)}m.unshift(g);b.apply(d,m)})}}function Z(){if(!(this instanceof Z))return kd||(kd=new Z),kd;this.ha=ec();this.g=new Fb;this.$=new Lb;this.u=[];this.ca="web2.87.1";this.l={};this.B=this.A=0;this.D=null}
